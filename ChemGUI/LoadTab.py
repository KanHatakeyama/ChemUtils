...
class LoadTab(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.file_path_excel = tk.StringVar(
            value=settings.load("file_path_excel"))
    ...
    def load_excel(self):
        ...
        self.combo = ttk.Combobox(
            self, values=sheet_names, state='readonly')
    ...
    def on_button_set_sheet(self):
        ...
        label = tk.Label(
            self, text=f'{file_path_excel} \n {sheetname} will be processed', font=('Arial', 12))
        label.pack()
